...
<body>
	<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
		<div
			...
			<a class="navbar-brand brand-logo font-weight-bold" href="#">SkyPhone</a>
			<a class="navbar-brand brand-logo-mini font-weight-bold" href="#"><img
				src="/images/logoJava5-removeBg.png" alt=""></a>
			<button
